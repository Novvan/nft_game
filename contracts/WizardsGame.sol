...
contract WizardsGame is ERC721 {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "This is an NFT that lets people play in the game Metaverse Wizards!", "image": "ipfs://',
    ...
    function attackBoss() public {
        ...
        if (bigBoss.hp < player.spellDamage) {
            bigBoss.hp = 0;
        } else {
            bigBoss.hp = bigBoss.hp - player.spellDamage;
        }
    ...
    function getAllDefaultWizards()
        public
        view
        returns (CharacterAttributes[] memory)
    {
        return defaultWizards;
    }
